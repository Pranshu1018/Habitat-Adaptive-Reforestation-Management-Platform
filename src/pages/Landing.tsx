...
const Landing = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'Land Health Analytics',
      description: 'Continuous monitoring with live weather data and scientific carbon calculations'
    }
  ];
