...
/**
 * Carbon Impact Adjustment Component
 * 
 * Displays carbon sequestration calculations with visible formulas
 * Shows the impact of land health on carbon capture
 */
        ...
        >
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 className="text-xl font-bold text-foreground">
                        Carbon Impact Adjustment
                    </h3>
                    <p className="text-sm text-muted-foreground">
                        Health-adjusted sequestration
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-3 pt-4 border-t border-border">
                ...
                >
                    ...
                    <div className="text-foreground leading-relaxed">
                        {carbonResult.formulas.adjustment}
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="text-foreground leading-relaxed">
                        {carbonResult.formulas.co2Conversion}
                    </div>
                </motion.div>
            </div>
