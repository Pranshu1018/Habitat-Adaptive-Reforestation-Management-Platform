...
/**
 * Living Land Vault Component
 * 
 * Displays the overall land health score with animated metrics
 * Features glassmorphism design with glow effects
 */
                ...
                <div className="mb-8">
                    <div className="flex items-baseline gap-3 mb-2">
                        ...
                        <div>
                            ...
                            <div className={cn('text-sm font-semibold', getGradeColor())}>
                                {grade}
                            </div>
                        </div>
                    </div>
                    <p className="text-sm text-muted-foreground">
                        Overall Land Health Score
                    </p>
                </div>
